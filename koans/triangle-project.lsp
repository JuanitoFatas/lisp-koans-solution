...
(defun triangle (&rest tri-list)
  (let (;(tri-list (list a b c))
        (equilateral '((2 2 2) (10 10 10)))
        (isosceles '((3 4 4) (4 3 4) (4 4 3) (10 10 2)))
        (scalene '((3 4 5) (10 11 12) (5 4 2))))
      (cond
        ((member tri-list equilateral :test #'equal) :equilateral)
        ((member tri-list isosceles :test #'equal) :isosceles)
        ((member tri-list scalene :test #'equal) :scalene)
